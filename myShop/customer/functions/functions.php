...
//getting the default for customer_session
    ...
    if(!isset($_GET['my_orders'])){
      if(!isset($_GET['edit_account'])){
        if(!isset($_GET['change_pass'])){
          ...
          $get_orders = "select * from pending_orders where customer_id='$customer_id' AND order_status='pending'";
          ...
          if($count_orders>0){
            ...
            <h3>Please see your orders details by clicking this <a href='my_account.php?my_orders'>
            LINK</a><br> Or you can <a href='pay_offline.php'>Pay Offline Now</a></h3>
            ...
            <h3>You can see your orders history by clicking this <a href='my_account.php?my_orders'>
            LINK</a><br>
